    ...
    <div class="container">
      ...
      <div class="navbar-collapse collapse justify-content-center" id="navbarDefault">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link " href="{{ route('page.property1') }}">Property</a>
          </li>

          <li class="nav-item">
            <a class="nav-link " href="{{ route('page.blog1') }}">Blog</a>
          </li>

          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Pages</a>
            <div class="dropdown-menu">
              <a class="dropdown-item " href="{{ route('page.property2') }}">Property Single</a>
              <a class="dropdown-item " href="{{ route('page.blogs2') }}">Blog Single</a>
              <a class="dropdown-item " href="{{ route('page.agents1') }}">Agents Grid</a>
              <a class="dropdown-item " href="{{ route('page.agents2') }}">Agent Single</a>
            </div>
          </li>
          <li class="nav-item">
            <a class="nav-link " href="{{ route('page.contact-page') }}">Contact</a>
          </li>
        </ul>
      </div>
